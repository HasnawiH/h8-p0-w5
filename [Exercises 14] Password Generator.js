function changeVocals (str) {
  ...
  function passwordGenerator(name){
    ...
    //reverseWord
    var balikHuruf = reverseWord(gantiHuruf)
  
    //setLowerUpperCase
    var hurufBesar = setLowerUpperCase(balikHuruf)
  
    //removeSpaces
    var hilangSpasi = removeSpaces(hurufBesar)
  
    // jadikan string
    var output = '';
    for (var i=0; i< hilangSpasi.length; i++){
      output += hilangSpasi[i];
    }
